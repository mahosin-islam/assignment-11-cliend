...
import { FaUser, FaEnvelope, FaPhone, FaMapMarkerAlt, FaEdit, FaUserCog } from "react-icons/fa";
      ...
      <div className=" shadow-lg rounded-2xl w-full max-w-3xl p-6 md:p-10">
        ...
        <div className="flex flex-col md:flex-row items-center md:items-start gap-6">
          ...
          <div className="flex-1">
            <h2 className="text-3xl font-bold text-gray-500">{user?.displayName}</h2>
            <p className="text-gray-500 mt-1 flex items-center gap-2">
              <FaEnvelope className="text-indigo-500" /> {user?.email}
            </p>
            <p className="text-gray-500 mt-1 flex items-center gap-2">
              <FaUserCog className="text-indigo-500" />Role {role}
            </p>
            <p className="text-gray-500 mt-1 flex items-center gap-2">
              <FaMapMarkerAlt className="text-indigo-500" />Status {status}
            </p>
             <div>
                {status=="suspend"?
                  <button 
        ...
        {/* About Section */}
        <div className="mt-8">
          <h3 className="text-2xl font-semibold text-gray-500 mb-4">About Me</h3>
          <p className="text-gray-600 leading-relaxed">
            Hello! I'm Mahosin, a passionate web developer from Dhaka, Bangladesh.
            I love creating beautiful and responsive web applications using React, Tailwind CSS, and modern technologies. 
