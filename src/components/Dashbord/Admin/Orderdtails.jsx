...
const Orderdtails = () => {
  ...
  return (
    <div className="min-h-screen  p-6 flex justify-center">
      <div className="bg-base-100 w-full max-w-4xl rounded-xl shadow-lg p-6 space-y-8">
        {/* Header */}
        <div className="flex justify-between items-center border-b pb-4">
          ...
          <span className="text-sm bg-base-100 text-blue-700 px-3 py-1 rounded-full">
            {status}
          </span>
        </div>
        ...
        <div className=" p-4 rounded-lg">
          <h2 className="text-lg font-semiboldmb-3">
            Payment Details
          </h2>
          <p>
